...
class EntityLoaderTest extends H2Database {
    ...
    void setUp() {
        ...
        this.orderEntityLoader = metaModel.getEntityLoader(Order.class);
        this.personEntityLoader = metaModel.getEntityLoader(Person.class);
